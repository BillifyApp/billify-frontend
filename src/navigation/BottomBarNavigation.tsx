...
import {groupName, groupNavName, homeNavName, notificationName, profileName, searchName,} from "../stores/route_names";
...
export default function BottomBarNavigation() {
    return (
        ...
        >
            ...
            <Tab.Screen name={groupNavName} component={GroupNavigation}
                        options={{
                            unmountOnBlur: true,
                            tabBarIcon: ({size, focused, color}) => {
                                return (
